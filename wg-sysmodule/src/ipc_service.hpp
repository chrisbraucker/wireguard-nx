...
#define WGNX_I_CONTROL_SERVICE_INTERFACE_DEBUG_INFO(C, H)                                                                                  \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::TriggerDebugPayload),                                                                            \
        ams::Result,                                                                                                                       \
        TriggerDebugPayload,                                                                                                               \
        (const wgnx::DebugTriggerRequest& request),                                                                                        \
        (request),                                                                                                                         \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::ReceiveInnerIpv4Packet),                                                                         \
        ams::Result,                                                                                                                       \
        ReceiveInnerIpv4Packet,                                                                                                            \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::BumpUdpBinding),                                                                                 \
        ams::Result,                                                                                                                       \
        BumpUdpBinding,                                                                                                                    \
        (),                                                                                                                                \
        (),                                                                                                                                \
...
#define WGNX_I_CONTROL_SERVICE_INTERFACE_INFO(C, H)                                                                                        \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::GetApiVersion),                                                                                  \
        ams::Result,                                                                                                                       \
        GetApiVersion,                                                                                                                     \
        (ams::sf::Out<u32> out),                                                                                                           \
        (out),                                                                                                                             \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::GetDaemonStatus),                                                                                \
        ams::Result,                                                                                                                       \
        GetDaemonStatus,                                                                                                                   \
        (ams::sf::Out<wgnx::DaemonStatus> out),                                                                                            \
        (out),                                                                                                                             \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::ListPeers),                                                                                      \
        ams::Result,                                                                                                                       \
        ListPeers,                                                                                                                         \
        (ams::sf::Out<u32> out_count, const ams::sf::OutArray<wgnx::PeerInfo>& out),                                                       \
        (out_count, out),                                                                                                                  \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::GetBuildInfo),                                                                                   \
        ams::Result,                                                                                                                       \
        GetBuildInfo,                                                                                                                      \
        (ams::sf::Out<wgnx::BuildInfo> out),                                                                                               \
        (out),                                                                                                                             \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::SetActivePeer),                                                                                  \
        ams::Result,                                                                                                                       \
        SetActivePeer,                                                                                                                     \
        (const wgnx::PeerSelectionRequest& request),                                                                                       \
        (request),                                                                                                                         \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::SetAutoStartPeer),                                                                               \
        ams::Result,                                                                                                                       \
        SetAutoStartPeer,                                                                                                                  \
        (const wgnx::PeerSelectionRequest& request),                                                                                       \
        (request),                                                                                                                         \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        C,                                                                                                                                 \
        H,                                                                                                                                 \
        static_cast<u32>(wgnx::CommandId::Shutdown),                                                                                       \
        ams::Result,                                                                                                                       \
        Shutdown,                                                                                                                          \
        (),                                                                                                                                \
        (),                                                                                                                                \
