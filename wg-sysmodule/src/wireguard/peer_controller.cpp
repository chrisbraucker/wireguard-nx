...
StagedPacketTransition PeerController::ApplyStagedSendOutcome(wg_peer& peer, const OutboundSendOutcome& outcome) const {
...
HandshakeTransition PeerController::PrepareFreshInitiation(wg_device& device, wg_peer& peer, bool begin_sequence) {
...
HandshakeTransition PeerController::HandleHandshakeRetryTimer(wg_device& device, wg_peer& peer) const {
