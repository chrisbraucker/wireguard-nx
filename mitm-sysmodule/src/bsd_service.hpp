...
#define WGNX_I_BSD_SYSTEM_SERVICE_INTERFACE_INFO(C, H)                                                                                     \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (out_size, out_errno, out_addr_len, fd, flags, buffer, address),                                                                   \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (out_size, out_errno, fd, flags, buffer, address),                                                                                 \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (out_result, out_errno, fd, address),                                                                                              \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (ams::sf::Out<s32> out_result,                                                                                                     \
         ...
         s32 fd,                                                                                                                           \
         ams::sf::OutAutoSelectBuffer address),                                                                                            \
        (out_result, out_errno, out_addr_len, fd, address),                                                                                \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
    ...
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (out_result, out_errno, fd, command, value),                                                                                       \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        (out_result, out_errno, fd, level, option, value),                                                                                 \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        ams::Result,                                                                                                                       \
        Shutdown,                                                                                                                          \
        (ams::sf::Out<s32> out_result, ams::sf::Out<s32> out_errno, s32 fd, s32 how),                                                      \
        (out_result, out_errno, fd, how),                                                                                                  \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )                                                                                                                                      \
    AMS_SF_METHOD_INFO(                                                                                                                    \
        ...
        ams::Result,                                                                                                                       \
        Close,                                                                                                                             \
        (ams::sf::Out<s32> out_result, ams::sf::Out<s32> out_errno, s32 fd),                                                               \
        (out_result, out_errno, fd),                                                                                                       \
        ams::hos::Version_Min,                                                                                                             \
        ams::hos::Version_Max                                                                                                              \
    )
