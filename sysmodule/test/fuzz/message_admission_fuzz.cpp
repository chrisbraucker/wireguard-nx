...
void OnHandshakeInitiation(
    void *, const wgnx::wireguard::message_handshake_initiation &) {
}

void OnHandshakeResponse(
    void *, const wgnx::wireguard::message_handshake_response &) {
}
...
void OnTransportData(
    void *,
    const wgnx::wireguard::message_transport_data &,
